document.addEventListener('DOMContentLoaded', () => {
    ...
    const THREADS = {
        ...
        'Percival Echo': {
            ...
            desc: "Consequences of Release: Documenting the direct causal link between the 'Becker' misidentification and the subsequent havoc wreaked upon his community as a result: many high-speed pursuits, law enforcement efforts wasted, and physical danger/harm (even deaths).). It underscores the high stakes of the initial police failure."
        },
        'Illusion of Choice': {
        ...
        'POther/Misc.': {
            ...
            desc: "Other Investigative Failures: Instances of potential bias, mishandling of evidence (e.g., theft jokes), and procedural violations that undermine the integrity of the prosecution's case."
        }
    };
    ...
    function createCard(clip) {
        ...
        // The data.js now provides 'run_ID/clip_name.mp4' as the filename
